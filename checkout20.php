...
<div class="container padding-bottom-x3">
  <div class="centerColumn">
    <h1 class="centerText">Large Box</h1>
    <p class="centerText biggerText">You are purchasing the Large Box. Fill out the below form and hit that button.</p>

    <form action="pay20.php" name="form" class="form-field" id="form" method="POST">
      ...
      <div class="container">
        <div class="large12">
          ...
          <p class="centerTextMobile">
            ...
            <a id="customButton" class="hide nb-button bigDarkButton darkBlueButton noUnderline margin-small fullButton">Purchase ($20)</a>
          </p>
        </div>
      </div>
...
<form action="pay20.php" method="POST" id="payment-form">
