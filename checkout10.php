...
<div class="container padding-bottom-x3">
  <div class="centerColumn">
    <h1 class="centerText">Medium Box</h1>
    <p class="centerText biggerText">You are purchasing the Medium Box. Fill out the below form and hit that button.</p>

    <form action="pay10.php" name="form" class="form-field" id="form" method="POST">
      ...
      <div class="container">
        <div class="large12">
          ...
          <p class="centerTextMobile">
            ...
            <a id="customButton" class="hide nb-button bigDarkButton darkBlueButton noUnderline margin-small fullButton">Purchase ($10)</a>
          </p>
        </div>
      </div>
...
<form action="pay10.php" method="POST" id="payment-form">
