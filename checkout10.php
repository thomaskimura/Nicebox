...
?>
	...
	<div class="container padding-bottom-x3">
      ...
      <h1 class="centerText">$10 Medium Box</h1>
			<p class="centerText biggerText">You are purchaseing the $10 box. Fill out the below form and hit the button.</p>
    ...
    <form name="form" class="form-field" id="form">
      ...
      <p>
        <a href="checkout20.php" class="nb-button bigButton noUnderline">Upgrade to Large Box</a>
