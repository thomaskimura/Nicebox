...
?>
	...
	<div class="container padding-bottom-x3">
      ...
      <div class="svg-container">
        <center>
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="717px" viewBox="0 0 717 400" enable-background="new 0 0 717 400" xml:space="preserve">

            <g class="floating" id="Box">
            	<g>
            		<g>
            ...
            <path class="fade5 hideOnSmall" id="X3" fill="#6EA1E0" d="M612.269,97.713l-2.5-2.499l2.5-2.5c1.381-1.381,1.381-3.62,0-5s-3.619-1.381-5,0l-2.5,2.5l-2.5-2.5
            ...
            <path class="fade3" id="X2" fill="#E9EDF2" d="M408.051,141.713l-2.5-2.499l2.5-2.5c1.381-1.381,1.381-3.62,0-5s-3.619-1.381-5.001,0l-2.499,2.5
            ...
            <path class="fade4" id="X1" fill="#F0D1C0" d="M173.894,102.616l-2.5-2.499l2.5-2.5c1.381-1.381,1.381-3.62,0-5s-3.619-1.381-5,0l-2.5,2.5
            ...
            <rect class="fade4" id="Diamond3" x="462.5" y="144" transform="matrix(0.7071 0.7071 -0.7071 0.7071 244.7865 -287.9669)" fill="#F0D1C0" width="15" height="15"/>
            <rect class="fade3" id="Diamond2" x="403.5" y="79" transform="matrix(0.7071 0.7071 -0.7071 0.7071 181.5439 -265.2856)" fill="#40669A" width="15" height="15"/>
            <rect class="fade4" id="Diamond1" x="169.5" y="196" transform="matrix(0.7071 0.7071 -0.7071 0.7071 195.7383 -65.5541)" fill="#6EA1E0" width="15" height="15"/>
            ...
            <circle class="fade5" id="Circle6" fill="#6EA1E0" cx="398" cy="29.208" r="9.542"/>
            ...
            <circle class="fade5" id="Circle2" fill="#E0E6EC" cx="235" cy="135.208" r="9.542"/>
