...
<div class="container padding-bottom-x3">
  <div class="centerColumn">
    ...
    <form action="pay5.php" name="form" class="form-field" id="form" method="POST">
      ...
      <div class="container">
        <div class="large12">
          ...
          <p class="centerTextMobile">
            ...
            <a id="customButton" class="hide nb-button bigDarkButton darkBlueButton noUnderline margin-small fullButton">Purchase ($5)</a>
          </p>
        </div>
      </div>
...
<form action="pay5.php" method="POST" id="payment-form">
